...
namespace GameMain.Lockstep
{
    ...
    public class ProtoObject : System.Runtime.Serialization.ISerializable
    {
        /// <summary>
        /// 
        /// </summary>
        ...
        public object Value
        {
            ...
            set
            {
                if (value is byte)
                    ...
                    _vect3 = (Vector3)value;
                else if (value is List<Vector3>)
                    _ls_vect3 = (List<Vector3>)value;
                else if (value is Vector2)
                    _vect2 = (Vector2)value;
        ...
        [ProtoMember(20)]
        private Vector3? _vect3;

        [ProtoMember(21)]
        private Vector2? _vect2;

        [ProtoMember(22)]
        private List<Vector3> _ls_vect3;
